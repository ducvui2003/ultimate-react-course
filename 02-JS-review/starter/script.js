...
const [primaryGenres, secondaryGenres, ...otherGenres] = genres; //rest
...
longBooks;
const allPagesBooks = books.reduce((sum, book) => sum + book.pages, 0);
allPagesBooks;
const arr = [3, 4, 1, 2, 8, 6];
